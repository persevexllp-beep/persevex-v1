...
// CORRECTED IMPORT: Import ThreeElements instead of MeshProps
...
// CORRECTED TYPE: Use the ThreeElements helper type for the props
export default function DustPlane(props: ThreeElements['mesh']) {

        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center space-x-4">
            {socialLinks.map((social) => (
                <a target='_blank' rel="noopener noreferrer" key={social.name} href={social.href} aria-label={social.name} className="text-gray-200 hover:text-[#F9C47D] transition-colors duration-300">
                    {social.icon}
                </a>
            ))}
          </div>
